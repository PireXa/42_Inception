...
if [ -f "/var/www/html/wordpress/wp-config.php" ]; then
	...
	wp --allow-root --path=/var/www/html/wordpress core config --dbhost=fde-albe_mariadb --dbname=$MYSQL_DATABASE --dbuser=$MYSQL_USER --dbpass=$MYSQL_PASSWORD --url=$DOMAIN_NAME
fi
